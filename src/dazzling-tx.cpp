...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Dazzling Core dazzling-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dazzling-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dazzling transaction") + "\n" +
                               "  dazzling-tx [options] -create [commands]   " + _("Create hex-encoded dazzling transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dazzling transaction
