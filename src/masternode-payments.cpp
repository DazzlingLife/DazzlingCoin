...
void FillBlockPayee(CMutableTransaction& txNew, CAmount nFees,
		bool fProofOfStake, bool fZDAZZStake) {
	CBlockIndex* pindexPrev = chainActive.Tip();
	if (!pindexPrev)
		return;
	...
	// } else {
	masternodePayments.FillBlockPayee(txNew, nFees, fProofOfStake, fZDAZZStake);
	// }
}
...
void CMasternodePayments::FillBlockPayee(CMutableTransaction& txNew,
		int64_t nFees, bool fProofOfStake, bool fZDAZZStake) {
	CBlockIndex* pindexPrev = chainActive.Tip();
