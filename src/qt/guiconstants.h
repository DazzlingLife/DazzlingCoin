...
/* Dazzling GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DAZZ"
#define QAPP_ORG_DOMAIN "dazzling.life"
#define QAPP_APP_NAME_DEFAULT "DAZZ-Qt"
#define QAPP_APP_NAME_TESTNET "DAZZ-Qt-testnet"
