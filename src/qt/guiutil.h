...
/** Utility functions used by the DAZZ Qt UI.
 */
namespace GUIUtil
{
...
// Render DAZZ addresses in monospace font
...
// Parse "dazzling:" URI into recipient object, return true on successful parsing
