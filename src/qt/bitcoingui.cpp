                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DAZZ Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DAZZ address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dazzling: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DAZZ Core"), this);
    aboutAction->setStatusTip(tr("Show information about DAZZ Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DAZZ"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DAZZ addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DAZZ addresses"));
    ...
    openAction->setStatusTip(tr("Open a DAZZ: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DAZZ Core help message to get a list with possible DAZZ command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DAZZ Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DAZZ network", "", count));
}
...
{
    QString strTitle = tr("DAZZ Core"); // default title
