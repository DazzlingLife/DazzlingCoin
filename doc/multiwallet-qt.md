...
In order to support loading of multiple wallets in dazzling-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dazzling.cpp.
...
Changes to dazzling.cpp
----------------------
dazzling.cpp is the entry point into dazzling-qt, and as such, will require some minor modifications to provide hooks for
